class FoodbyNameResponse {
  List<MealsByName>? meals;

  FoodbyNameResponse({this.meals});

  FoodbyNameResponse.fromJson(Map<String, dynamic> json) {
    if (json['meals'] != null) {
      meals = <MealsByName>[];
      json['meals'].forEach((v) {
        meals!.add(new MealsByName.fromJson(v));
      });
    }
  }
...
class MealsByName {
  ...
  MealsByName.fromJson(Map<String, dynamic> json) {
    idMeal = json['idMeal'];
