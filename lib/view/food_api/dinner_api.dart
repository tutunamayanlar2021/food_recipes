class DinnerApi {
  ...
  DinnerApi({this.from, this.to, this.count, this.lLinks, this.hits});

  DinnerApi.fromJson(Map<String, dynamic> json) {
    from = json['from'];
    to = json['to'];
    count = json['count'];
    lLinks =
        json['_links'] != null ? new LinksSelf.fromJson(json['_links']) : null;
    if (json['hits'] != null) {
      hits = <Hits>[];
      json['hits'].forEach((v) {
...
class LinksNext {
  ...
  LinksNext.fromJson(Map<String, dynamic> json) {
...
class LinksSelf {
  ...
  LinksSelf.fromJson(Map<String, dynamic> json) {
